...
import { getEventById, getRelatedEventsByStyle } from '@/lib/actions/event.actions'
...
const EventDetails = async ({ params: { id }, searchParams }: SearchParamProps) => {
    ...
    const relatedEvents = await getRelatedEventsByStyle({
        styleId: event.style._id,
        eventId: event._id,
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 2xl:max-w-7xl'>
                    ...
                    <div className='flex w-full flex-col gap-8 p-5 md:p-10'>
                        ...
                        <div className='flex flex-col gap-2'>
                            ...
                            <p className='p-medium-16 lg-regular-18 truncate text-primary-500'>{event.url}</p>
                        </div>
